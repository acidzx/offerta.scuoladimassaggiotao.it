      ...
      <section className="bg-white  mt-5">
        <div className="py-6 px-4 mx-auto max-w-screen-xl text-center lg:pb-8 lg:px-12">
          <label
            htmlFor="modalForm"
            href="#"
            className="cursor-pointer inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full  hover:bg-gray-200 "
            role="alert"
          >
