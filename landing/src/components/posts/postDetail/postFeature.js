  ...
  return (
    <div className="hidden lg:block">
      <div className="containerFull">
        <div
          className="z-10 mx-auto my-16  max-w-7xl py-6 pb-5 lg:px-8"
          aria-labelledby="contact-heading"
        >
          <h2 className="sr-only" id="contact-heading">
            Features
          </h2>
          <div className="grid grid-cols-1 max-w-[200px] md:max-w-none gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
